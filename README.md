...
2. Run this `extend-event-handler-go` sample app.
...
2. Create event handler app, please refer to the docs in [here](https://docs-preview.accelbyte.io/gaming-services/services/customization/)
